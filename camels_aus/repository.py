...
class CamelsAus:
    ...
    def load_from_text_files(self, directory: str, version: str = "1.0") -> None:
        ...
        streamflow_signatures_fn = os.path.join(
            streamflow_dir, "streamflow_signatures.csv"
        )
        _check_fileexists(streamflow_signatures_fn)
        _streamflow_signatures = load_streamflow_signatures(
            streamflow_signatures_fn
        )
        ...
        d.update(_streamflow_signatures)
    ...
    @property
    def location_attributes(self) -> xr.DataArray:
        return self._ds[location_boundary_names()]
    
    @property
    def streamflow_attributes(self) -> xr.DataArray:
        return self._ds[streamflow_signatures_names()]
